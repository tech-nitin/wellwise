...
const sequence = [
  { key: 'overview', label: '01  Surface setup', duration: 2800, camera: [15.2, 8.4, 16.2], target: [0, -1.0, 0], drill: 0.04, casing: 0.72, reservoir: 0.05, formation: 0.36, ring: 0.0 },
  { key: 'overview', label: '02  Wellhead inspection', duration: 2500, camera: [8.4, 5.1, 9.2], target: [0, 3.35, 0], drill: 0.08, casing: 0.82, reservoir: 0.06, formation: 0.40, ring: 0.0 },
  { key: 'well', label: '03  Planned well section', duration: 3200, camera: [12.8, 4.0, 14.0], target: [0, -1.8, 0], drill: 0.22, casing: 0.84, reservoir: 0.08, formation: 0.43, ring: 0.0 },
  { key: 'lithology', label: '04  Formation / reservoir review', duration: 3400, camera: [13.6, 1.3, 9.3], target: [0.0, -3.8, 0], drill: 0.45, casing: 0.42, reservoir: 0.26, formation: 0.62, ring: 0.0 },
  { key: 'bha', label: '05  BHA run-in', duration: 3300, camera: [7.4, -0.6, 9.0], target: [2.1, -6.7, 0.18], drill: 0.88, casing: 0.28, reservoir: 0.24, formation: 0.27, ring: 0.0 },
  { key: 'bha', label: '06  Bit / BHA inspection', duration: 2500, camera: [4.6, -4.6, 4.8], target: [2.8, -7.6, 0.35], drill: 1.0, casing: 0.24, reservoir: 0.18, formation: 0.22, ring: 1.0 },
  { key: 'casing', label: '07  Run casing string', duration: 3200, camera: [10.8, 6.1, 14.8], target: [0, -2.5, 0], drill: 0.34, casing: 1.0, reservoir: 0.14, formation: 0.34, ring: 0.0 },
  { key: 'casing', label: '08  Casing / shoe check', duration: 2800, camera: [9.0, 0.7, 8.4], target: [0.2, -4.0, 0], drill: 0.22, casing: 1.0, reservoir: 0.17, formation: 0.38, ring: 0.0 },
  { key: 'evaluation', label: '09  Final evaluation', duration: 3600, camera: [14.0, 6.2, 16.0], target: [0.3, -3.3, 0], drill: 0.72, casing: 0.80, reservoir: 0.34, formation: 0.48, ring: 0.0 },
];
